...
class WizardExportCsvPrevired(models.TransientModel):
    ...
    def action_generate_csv(self):
        ...
        for payslip in payslip_recs:
            ##CONDICION PARA NO INCLUIR A PERSONAL DEL EXTRANJERO #####
            if payslip.employee_id.work_location!="ABROAD":
                ...
                line_employee = [self._acortar_str(rut, 11), 
                                 ...
                                 int(round(self.get_payslip_lines_value_2(payslip,'TOTIM'))) if payslip.contract_id.isapre_id.codigo=='07' else "0",
                                 ...
                                 #"0",
                                 int(round(self.get_payslip_lines_value_2(payslip,'FONASA'))) if payslip.contract_id.isapre_id.codigo=='07' else "0",
    ...
    #caso se paga en la mutual respectiva. Datos no numérico 
                                 ...
                                 int(self.get_payslip_lines_value_2(payslip,'CAJACOMP')) if self.get_payslip_lines_value_2(payslip,'CAJACOMP') else "0",
